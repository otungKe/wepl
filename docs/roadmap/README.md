...
|---|-------|------|---------------|------|--------|
| 0 | [Ledger-First Cutover (Legacy Wipe)](PHASE-0-ledger-cutover.md) | Make double-entry authoritative; delete all legacy money code | 3 (solid) | [#4](https://github.com/otungKe/wepl/issues/4) | 🟡 In progress (P0-01–04 done) |
