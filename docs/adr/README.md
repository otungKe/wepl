...
| [0027](0027-fund-ownership-treatment.md) | Attribution, ownership, and the two-register model | Accepted |
| [0028](0028-settlement-discovery-vs-propagation.md) | Settlement — discovery vs propagation | Accepted |
...
| [0034](0034-inconclusive-rail-never-reverses.md) | An inconclusive rail never reverses a payout | Accepted |
