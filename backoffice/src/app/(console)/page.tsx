  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-6 rounded-xl border border-dashed border-slate-300 bg-white/50 p-6 text-sm text-slate-500 dark:border-slate-700 dark:bg-slate-900/40">
        ...
        <p className="mt-1">Navigation, staff auth, RBAC and federated search are live. Each module fills in with its
          real queues and KPIs across phases P1–P4. Use search (⌘K) to jump to any user, community or journal you can access.</p>
      </div>
    </div>
  )
}
