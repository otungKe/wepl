...
const styles = StyleSheet.create({
  ...
  balanceLabel: { fontSize: FONTS.sm, color: "rgba(255,255,255,0.75)", marginBottom: 4, fontWeight: "600" },
  balanceAmount: { fontSize: 32, fontWeight: "700", color: COLORS.white, marginBottom: 4 },
  ...
  sectionTitle: { fontSize: FONTS.sm, fontWeight: "600", color: COLORS.textMuted, marginBottom: 12 },

  emptyBox: { backgroundColor: COLORS.white, padding: 24, borderRadius: RADIUS.lg, alignItems: "center" },
  emptyTitle: { fontSize: FONTS.md, fontWeight: "600", color: COLORS.textSecondary, marginBottom: 6 },
  ...
  claimAmount: { fontSize: FONTS.lg, fontWeight: "700", color: COLORS.text },
  ...
  voteBtnText: { color: COLORS.white, fontWeight: "700" },
